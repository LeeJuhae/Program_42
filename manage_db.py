...
def connect_db():
	engine = create_engine(os.environ['CLEARDB_DATABASE_URL'], encoding = 'utf-8', convert_unicode=False, pool_pre_ping=True, pool_size=20, pool_recycle=-1, max_overflow=20)
	# debug
